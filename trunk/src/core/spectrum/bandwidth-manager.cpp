  ...
  if (dlBw == 1.4)
    {
      for (int i = dlOffset; i < dlOffset + RBs_FOR_1_4_MHz; i++)
        {
    	  m_dlSubChannels.push_back(DL_LOW_FREQUENCY_BAND_1 + (i * 0.018));
        }
    }
  else if (dlBw == 3)
    {
  ...
  if (ulBw == 1.4)
    {
      for (int i = ulOffset; i < ulOffset + RBs_FOR_1_4_MHz; i++)
        {
    	  m_ulSubChannels.push_back(UL_LOW_FREQUENCY_BAND_1 + (i * 0.018));
        }
    }
  else if (ulBw == 3)
    {
  ...
  if (dlBw == 1.4)
	{
	  for (int i = dlOffset; i < dlOffset + RBs_FOR_1_4_MHz; i++)
		{
		  m_dlSubChannels.push_back(DL_LOW_FREQUENCY_BAND_1 + (i * 0.018));
		  m_ulSubChannels.push_back(DL_LOW_FREQUENCY_BAND_1 + (i * 0.018));
		}
	}
  else if (dlBw == 3)
	{
  ...
  if (ulBw == 1.4)
	{
	  for (int i = ulOffset; i < ulOffset + RBs_FOR_1_4_MHz; i++)
		{
		  m_ulSubChannels.push_back(UL_LOW_FREQUENCY_BAND_1 + (i * 0.018));
		  m_dlSubChannels.push_back(UL_LOW_FREQUENCY_BAND_1 + (i * 0.018));
		}
	}
  else if (ulBw == 3)
	{
